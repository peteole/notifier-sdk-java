...
notifier
- API version: 0.3.2
  - Build date: 2022-08-24T13:44:19.817302Z[Etc/UTC]
...
*CrateApi* | [**handleGetTelegramChatId**](docs/CrateApi.md#handleGetTelegramChatId) | **GET** /get_telegram_chat_id/{username} | Get the chat ID of a telegram username
