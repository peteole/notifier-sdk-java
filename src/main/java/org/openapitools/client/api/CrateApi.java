...
public class CrateApi {
     ...
     * @param username User id to get notification channels for (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns the chat ID </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Could not look up username </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call handleGetTelegramChatIdCall(String username, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/get_telegram_chat_id/{username}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call handleGetTelegramChatIdValidateBeforeCall(String username, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'username' is set
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling handleGetTelegramChatId(Async)");
        }
        

        okhttp3.Call localVarCall = handleGetTelegramChatIdCall(username, _callback);
        return localVarCall;
     ...
     */
    public String handleGetTelegramChatId(String username) throws ApiException {
        ApiResponse<String> localVarResp = handleGetTelegramChatIdWithHttpInfo(username);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> handleGetTelegramChatIdWithHttpInfo(String username) throws ApiException {
        okhttp3.Call localVarCall = handleGetTelegramChatIdValidateBeforeCall(username, null);
     ...
     */
    public okhttp3.Call handleGetTelegramChatIdAsync(String username, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = handleGetTelegramChatIdValidateBeforeCall(username, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
